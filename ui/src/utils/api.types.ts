...
export type DiscardGameAction = [Color, "DISCARD", null | ResourceCard[]];
export type BuyDevelopmentCardAction = [Color, "BUY_DEVELOPMENT_CARD", null | DevelopmentCard | [DevelopmentCard | null, number]];
